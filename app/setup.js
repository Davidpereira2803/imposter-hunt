...
import { View, Text, TextInput, TouchableOpacity, FlatList, StyleSheet, Alert, BackHandler } from "react-native";
...
const s = StyleSheet.create({
  ...
  title: { color: "#fff", fontSize: 28, fontWeight: "900", textAlign: "center", marginBottom: 32 },
  ...
  btn: { paddingHorizontal: 20, paddingVertical: 16, borderRadius: 12, justifyContent: "center" },
  btnText: { color: "#fff", fontWeight: "700", fontSize: 16 },
  primary: { backgroundColor: "#23a6f0" },
  playerList: { maxHeight: 120 },
  playerItem: { flexDirection: "row", alignItems: "center", backgroundColor: "#1a1a1a", padding: 16, borderRadius: 12, marginBottom: 8 },
  playerName: { flex: 1, color: "#fff", fontSize: 16, fontWeight: "600" },
  removeBtn: { backgroundColor: "#e63946", width: 32, height: 32, borderRadius: 16, justifyContent: "center", alignItems: "center" },
  removeText: { color: "#fff", fontSize: 20, fontWeight: "700" },
  topicGrid: { flexDirection: "row", flexWrap: "wrap", gap: 12 },
  topicBtn: { backgroundColor: "#1a1a1a", paddingVertical: 16, paddingHorizontal: 20, borderRadius: 12, minWidth: 100, alignItems: "center" },
  topicSelected: { backgroundColor: "#23a6f0" },
  topicText: { color: "#fff", fontSize: 16, fontWeight: "600" },
  topicTextSelected: { color: "#fff", fontWeight: "700" },
  startBtn: { backgroundColor: "#06d6a0", paddingVertical: 18, borderRadius: 16, alignItems: "center", marginTop: 20 },
  startText: { color: "#000", fontSize: 18, fontWeight: "900" },
